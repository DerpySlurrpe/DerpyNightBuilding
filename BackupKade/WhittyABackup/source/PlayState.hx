...
class PlayState extends MusicBeatState
{
		...
		if (SONG.stage == null)
		{
			switch (storyWeek)
			{
				...
				case 6:
					...
					case 7:
					if (songLowercase == 'overhead')
					{
						stageCheck = 'whittyFront';
					}
					else
					{
						stageCheck = 'whittyBack';
					}
	...
	case 'whittyBack':
						...
						var whittyBack:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('whittyBack'));
						whittyBack.antialiasing = FlxG.save.data.antialiasing;
						whittyBack.scrollFactor.set(0.9, 0.9);
						whittyBack.active = false;
						add(whittyBack);
						
						
						
						var whittyFront:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('whittyFront'));
						whittyFront.antialiasing = FlxG.save.data.antialiasing;
