	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				case 'kapi':
		Paths.getSparrowAtlas('characters/kapi','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'Dad idle dance', 12, false);
				animation.addByPrefix('singUP', 'Dad Sing Note UP', 10, false);
				animation.addByPrefix('singRIGHT', 'Dad Sing Note RIGHT', 10, false);
				animation.addByPrefix('singDOWN', 'Dad Sing Note DOWN', 10, false);
				animation.addByPrefix('singLEFT', 'Dad Sing Note LEFT', 10, false);
				...
				case 'bfreanimated':
				var tex = Paths.getSparrowAtlas('characters/ReAnimatedBF', 'shared');
				frames = tex;
