	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				frames = tex;
				animation.addByPrefix('idle', 'Fleetway Idle', 10, false);
				animation.addByPrefix('singUP', 'Fleetway Up', 10, false);
				animation.addByPrefix('singRIGHT', 'Fleetway Right', 14, false);
				animation.addByPrefix('singDOWN', 'Fleetway Down', 14, false);
				animation.addByPrefix('singLEFT', 'Fleetway Left', 14, false);
				animation.addByPrefix('howFast', 'Fleetway How Fast', 91, false);
			...
			case 'kapi':
				...
				animation.addByPrefix('firstDeath', "BF dies", 40, false);
				animation.addByPrefix('deathLoop', "BF Dead Loop", 0, false);
				animation.addByPrefix('deathConfirm', "BF Dead confirm", 0, false);
